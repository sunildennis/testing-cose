...
function onSuccess(position){
    ...
    fetch(`https://api.opencagedata.com/geocode/v1/json?q=${latitude}+${longitude}&key=393790bdbf754c619344594062d32459`)
    ...
    .then(response => response.json()).then(response =>{
        ...
        let {municipality, postcode, country,district} = allDetails; //getting country, postcode, country properties value from allDetails obj
        button.innerText = `${postcode}, ${country}, ${municipality},${district}`; //passing these value to the button innerText
